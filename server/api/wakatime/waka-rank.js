  ...
  for (let i = 0; i < data.length; i++) {
    ...
    contents.push({
      ...
      contents: [
        ...
        {
          type: 'text',
          text: mintify(row.running_total.human_readable_total),
          gravity: 'bottom',
          size: 'xs',
          flex: 3,
          margin: 'sm'
        ...
        {
          type: 'text',
          text: mintify(row.running_total.human_readable_daily_average),
          gravity: 'bottom',
          size: 'xs',
          flex: 3,
          margin: 'sm'
        ...
        {
          type: 'text',
          text: row.running_total.languages.map(l => l.name).join() || 'N/A',
          gravity: 'bottom',
          size: 'xs',
          color: '#ababab',
          flex: 5,
